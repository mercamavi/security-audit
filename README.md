...
## Scenario:
The exercise set out a scenario in which the IT manager completed a risk assessment and established an audit scope and goals. You need to review these documents, perform an audit to complete a controls assessment and compliance checklist, analyze your findings, develop recommendations and communicate with stakeholders with the aim of improving the security posture of the organization, as well as using it to justify new hires for the security team.
